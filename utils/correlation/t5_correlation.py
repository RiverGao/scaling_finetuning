...
with pd.ExcelWriter(f'correlation/t5/{model_size}/{part}/amr_{model_size}_{method}.xlsx') as writer_bert:
    with pd.ExcelWriter(f'correlation/t5/{model_size}-random/{part}/amr_{model_size}-random_{method}.xlsx') as writer_random:
